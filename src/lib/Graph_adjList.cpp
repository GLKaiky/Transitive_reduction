 ...
 * @brief     Implementation of Graph operations and Transitive Reduction
 * @version   0.2
 * @date      2026-06-26
...
void Graph_adjList::execute_transitive_reduction() {
    ...
    // 4.2 Reconectar as pontes que sobreviveram à poda
    for (unsigned int u = 0; u < num_sccs; u++) {
        for (int v : DAG.adjList[u]) {
            // Liga o menor membro do grupo U ao menor membro do grupo V
